...
public class SpriteTimeline : ISTE
{
	...
	List<DraggableTexture> frames = new List<DraggableTexture>();
	...
	*/
					...
					switch (Event.current.keyCode)
					{
						...
						case KeyCode.RightArrow:
							...
							if (selectedFrame != null)
								...
								{
									ChangeSelectedFrame(frames[Mathf.Clamp(selectedFrame.index + 1, 0, frames.Count - 1)]);
									Event.current.Use();
								}
							break;
	...
	void AppendTextures(Object[] objs)
	{
		...
		List<string> newFrameList = new List<string>();		// Array of paths
		List<Texture2D> sortedNewList = new List<Texture2D>();	// Array of new Texture2Ds
		...
		sprite.States[selectedAnim].frameGUIDs = (string[])newFrameList.ToArray();
...
public class DraggableTextureComparer : IComparer<DraggableTexture>
{
	public int Compare(DraggableTexture a, DraggableTexture b)
	{
...
public class TextureNameComparer : IComparer<Texture2D>
{
