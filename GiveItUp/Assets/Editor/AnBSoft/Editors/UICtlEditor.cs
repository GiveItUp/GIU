...
public class UICtlEditor : EditorWindow, IGUIHelper, IGUIScriptSelector
{
	...
	public GameObject[] GetAllGOsInScene()
	{
		List<GameObject> objs = new List<GameObject>();

		#if UNITY_3_0 || UNITY_3_1 || UNITY_3_2 || UNITY_3_3 || UNITY_3_4 || UNITY_3_5 || UNITY_3_6 || UNITY_3_7 || UNITY_3_8 || UNITY_3_9 || UNITY_4_0 || UNITY_4_1 || UNITY_4_2 || UNITY_4_3 || UNITY_4_4 || UNITY_4_5 || UNITY_4_6 || UNITY_4_7 || UNITY_4_8 || UNITY_4_9|| UNITY_5
		GameObject[] gos = Resources.FindObjectsOfTypeAll(typeof(GameObject)) as GameObject[];
#else
		GameObject[] gos = FindObjectsOfTypeAll(typeof(GameObject)) as GameObject[];
#endif
	...
	int BuildScriptList(MonoBehaviour selScript)
	{
		...
		//Object[] objs = FindObjectsOfTypeAll(typeof(GameObject));
		GameObject[] objs = GetAllGOsInScene();
		...
		{
			Component[] comps = objs[i].GetComponents(typeof(MonoBehaviour));

			if (comps == null)
				continue;

			for (int j = 0; j < comps.Length; ++j)
				s.Add((MonoBehaviour)comps[j]);
		}
