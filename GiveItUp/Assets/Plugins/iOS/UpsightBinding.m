...
#define UPSIGHT_PLUGIN_VERSION @"ios-unity-3.0.1"
...
void _usSendContentRequestWithContentUnitID( const char* contentUnitID, const char* messageID, BOOL showsOverlayImmediately, BOOL shouldAnimate, const char* dimensions )
{
	RequiresInit();
