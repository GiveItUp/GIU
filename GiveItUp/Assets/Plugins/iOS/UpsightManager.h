...
- (void)sendContentRequestWithContentUnitID:(NSString*)contentUnitID messageID:(NSString*)messageID showsOverlayImmediately:(BOOL)showsOverlayImmediately shouldAnimate:(BOOL)shouldAnimate dimensions:(NSDictionary *)dimensions;
