...
//#if UNITY_IPHONE
	public static class ShareSDK
	{
		...
		{
			object dataObj = com.monstar.MiniJSON.jsonDecode (data);
		...
		public static void setPlatformConfig (PlatformType type, Hashtable configInfo)
		{
			...
			if (configInfo != null)
			{
				confStr = com.monstar.MiniJSON.jsonEncode (configInfo);
			}
		...
		public static void shareContent (PlatformType type, Hashtable content, ShareResultEvent resultHandler)
		{
			...
			if (content != null)
			{
				contentStr = com.monstar.MiniJSON.jsonEncode(content);
			}
		...
		public static void oneKeyShareContent (PlatformType[] types, Hashtable content, ShareResultEvent resultHandler)
		{
			...
			if (types != null)
			{
				...
				platTypesStr = com.monstar.MiniJSON.jsonEncode(platTypesArr.ToArray());
			}
			
			__iosShareSDKOneKeyShare (platTypesStr, com.monstar.MiniJSON.jsonEncode(content), _callbackObjectName);
		}
		...
		public static void showShareMenu (PlatformType[] types, Hashtable content, int x, int y, MenuArrowDirection direction, ShareResultEvent resultHandler)
		{
			...
			__iosShareSDKShowShareMenu (platTypesStr, com.monstar.MiniJSON.jsonEncode(content), x, y, (int)direction, _callbackObjectName);
		}
		...
		public static void showShareView (PlatformType type, Hashtable content, ShareResultEvent resultHandler)
		{
			...
			__iosShareSDKShowShareView ((int)type, com.monstar.MiniJSON.jsonEncode(content), _callbackObjectName);
		}
		...
		public static void getFriends (PlatformType type, Hashtable page, GetFriendsResultEvent resultHandler)
		{
			...
			__iosShareSDKGetFriendsList((int)type, com.monstar.MiniJSON.jsonEncode(page), _callbackObjectName);
		}
